...
SUBJECT_CHOICES = [
    ('BEI001', 'Software Engineering'),
    ('BEI002', 'System Analysis and Design'),
    ('BEI003', 'Operating System'),
    ('BEI004', 'Object Oriented Programming'),
    ('BEI005', 'Electornics & Instrumentation')
]
