...
SUBJECT= [
    ('BEI001', 'Signals and Systems'),
    ('BEI002', 'Instrumentation'),
    ('BEI003', 'Electromagnetics'),
    ('BEI004', 'Numerical methods'),
    ('BEI005', 'Discrete Structures'),
...
class Material(models.Model):
    ...
    description= models.CharField(max_length=255, null= False, blank=False, verbose_name='material description')
    subject= models.CharField(max_length=20, choices=SUBJECT, default= 'N/A', verbose_name=' Materials ubject') 
    material_file= models.FileField(upload_to='material/',null=False, blank=False, verbose_name='seletct file')
    upload_file= models.DateTimeField(default=datetime.now(), verbose_name='upload date')
